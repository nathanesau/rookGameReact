...
export const BiddingPanel = ({
  ...
  const minBid = currentBid ? currentBid.amount + 5 : 70;
  const maxBid = 120;
    ...
    <div className={styles.biddingPanel} role="region" aria-label="Bidding controls">
      <div className={styles.header}>
        ...
        {currentBid && (
          <div className={styles.currentBid} aria-live="polite">
            Current Bid: <strong>{currentBid.amount}</strong>
          </div>
        )}
      </div>
      ...
      {!hasPassedAlready ? (
        <div className={styles.controls}>
          ...
          {!isMyTurn && !hasPassedAlready && (
            <div className={styles.waitingMessage} role="status" aria-live="polite">
